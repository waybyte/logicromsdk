 ...
 * @note Task timer will stop running if task is waiting on a semaphore or mutex or any blocking function call. Please use system timer APIs in that case.
 * @param cb		[in] timer callback function of type @ref timer_callback_f
...
/**
 * Start Task timer
 * @param tid		[in] Timer ID returned by @c task_timer_register()
